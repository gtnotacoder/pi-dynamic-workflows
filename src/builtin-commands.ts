    ...
    pi.registerCommand("deep-research", {
      ...
      async handler(args: string, ctx: ExtensionCommandContext) {
        ...
        try {
          ...
          // citation limits, re-fetches retained citations, derives the
          // acknowledgement from verified evidence, surfaces writer failure,
          // and delivers path + claim/source
          ...
          // success.
          const outcome = await deliverDeepResearchResult(question, result, defaultResearchReportWriter);
          if (!outcome.ok) {
